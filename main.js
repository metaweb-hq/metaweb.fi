...
if (!isMobile()) {
	document.body.onmousemove = function(e) {
		camera.rotate.x = (e.pageY-document.documentElement.scrollTop)/window.innerHeight * 180 - 90;
...
let WINDOW_SCALE = Math.min(window.innerWidth/1536+0.1,1); // Hack, would have to re-write later

var textSet = [
    {text:"METAWEB", sphereRadius:140*WINDOW_SCALE, sphereSpace:90*WINDOW_SCALE, unitTime:100, time:1000},
    {text:"FUTURE", sphereRadius:120*WINDOW_SCALE, sphereSpace:70*WINDOW_SCALE, unitTime:120, time:2000},
